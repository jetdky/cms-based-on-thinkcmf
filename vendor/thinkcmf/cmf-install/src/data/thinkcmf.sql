...
(43, 42, 2, 0, 10000, 'admin', 'Plugin', 'toggle', '', '插件显示禁用', '', '插件显示禁用'),
...
(68, 61, 2, 0, 10000, 'admin', 'Route', 'open', '', '路由规则显示', '', '路由规则显示'),
...
(78, 6, 1, 1, 40, 'admin', 'Slide', 'index', '', '标签库管理', '', '标签库管理'),
(79, 78, 1, 0, 10000, 'admin', 'Slide', 'add', '', '添加标签库', '', '添加标签库'),
(80, 78, 2, 0, 10000, 'admin', 'Slide', 'addPost', '', '添加标签库提交', '', '添加标签库提交'),
(81, 78, 1, 0, 10000, 'admin', 'Slide', 'edit', '', '编辑标签库', '', '编辑标签库'),
(82, 78, 2, 0, 10000, 'admin', 'Slide', 'editPost', '', '编辑标签库提交', '', '编辑标签库提交'),
(83, 78, 2, 0, 10000, 'admin', 'Slide', 'delete', '', '删除标签库', '', '删除标签库'),
(84, 78, 1, 0, 10000, 'admin', 'SlideItem', 'index', '', '标签库页面列表', '', '标签库页面列表'),
(85, 84, 1, 0, 10000, 'admin', 'SlideItem', 'add', '', '标签库页面添加', '', '标签库页面添加'),
(86, 84, 2, 0, 10000, 'admin', 'SlideItem', 'addPost', '', '标签库页面添加提交', '', '标签库页面添加提交'),
(87, 84, 1, 0, 10000, 'admin', 'SlideItem', 'edit', '', '标签库页面编辑', '', '标签库页面编辑'),
(88, 84, 2, 0, 10000, 'admin', 'SlideItem', 'editPost', '', '标签库页面编辑提交', '', '标签库页面编辑提交'),
(89, 84, 2, 0, 10000, 'admin', 'SlideItem', 'delete', '', '标签库页面删除', '', '标签库页面删除'),
(90, 84, 2, 0, 10000, 'admin', 'SlideItem', 'ban', '', '标签库页面隐藏', '', '标签库页面隐藏'),
(91, 84, 2, 0, 10000, 'admin', 'SlideItem', 'cancelBan', '', '标签库页面显示', '', '标签库页面显示'),
(92, 84, 2, 0, 10000, 'admin', 'SlideItem', 'listOrder', '', '标签库页面排序', '', '标签库页面排序'),
...
(100, 95, 2, 0, 10000, 'admin', 'Theme', 'active', '', '显示模板', '', '显示模板'),
(101, 95, 1, 0, 10000, 'admin', 'Theme', 'files', '', '模板文件列表', '', '显示模板'),
...
(120, 111, 2, 0, 10000, 'admin', 'User', 'cancelBan', '', '显示管理员', '', '显示管理员'),
...
(125, 124, 2, 0, 10000, 'user', 'AdminIndex', 'ban', '', '本站用户隐藏', '', '本站用户隐藏'),
(126, 124, 2, 0, 10000, 'user', 'AdminIndex', 'cancelBan', '', '本站用户显示', '', '本站用户显示'),
...
(42, 1, 'admin', 'admin_url', 'admin/Plugin/toggle', '', '插件显示禁用', ''),
...
(66, 1, 'admin', 'admin_url', 'admin/Route/open', '', '路由规则显示', ''),
...
(77, 1, 'admin', 'admin_url', 'admin/Slide/index', '', '标签库管理', ''),
(78, 1, 'admin', 'admin_url', 'admin/Slide/add', '', '添加标签库', ''),
(79, 1, 'admin', 'admin_url', 'admin/Slide/addPost', '', '添加标签库提交', ''),
(80, 1, 'admin', 'admin_url', 'admin/Slide/edit', '', '编辑标签库', ''),
(81, 1, 'admin', 'admin_url', 'admin/Slide/editPost', '', '编辑标签库提交', ''),
(82, 1, 'admin', 'admin_url', 'admin/Slide/delete', '', '删除标签库', ''),
(83, 1, 'admin', 'admin_url', 'admin/SlideItem/index', '', '标签库页面列表', ''),
(84, 1, 'admin', 'admin_url', 'admin/SlideItem/add', '', '标签库页面添加', ''),
(85, 1, 'admin', 'admin_url', 'admin/SlideItem/addPost', '', '标签库页面添加提交', ''),
(86, 1, 'admin', 'admin_url', 'admin/SlideItem/edit', '', '标签库页面编辑', ''),
(87, 1, 'admin', 'admin_url', 'admin/SlideItem/editPost', '', '标签库页面编辑提交', ''),
(88, 1, 'admin', 'admin_url', 'admin/SlideItem/delete', '', '标签库页面删除', ''),
(89, 1, 'admin', 'admin_url', 'admin/SlideItem/ban', '', '标签库页面隐藏', ''),
(90, 1, 'admin', 'admin_url', 'admin/SlideItem/cancelBan', '', '标签库页面显示', ''),
(91, 1, 'admin', 'admin_url', 'admin/SlideItem/listOrder', '', '标签库页面排序', ''),
...
(99, 1, 'admin', 'admin_url', 'admin/Theme/active', '', '显示模板', ''),
...
(119, 1, 'admin', 'admin_url', 'admin/User/cancelBan', '', '显示管理员', ''),
...
(125, 1, 'user', 'admin_url', 'user/AdminIndex/ban', '', '本站用户隐藏', ''),
(126, 1, 'user', 'admin_url', 'user/AdminIndex/cancelBan', '', '本站用户显示', ''),
...
(42, 2, 1, '后台标签库管理界面', 'admin_slide_index_view', 'admin', '后台标签库管理界面'),
...
(64, 2, 1, '后台标签库页面列表界面', 'admin_slide_item_index_view', 'admin', '后台标签库页面列表界面'),
(65, 2, 1, '后台标签库页面添加界面', 'admin_slide_item_add_view', 'admin', '后台标签库页面添加界面'),
(66, 2, 1, '后台标签库页面编辑界面', 'admin_slide_item_edit_view', 'admin', '后台标签库页面编辑界面'),
...
CREATE TABLE IF NOT EXISTS `cmf_slide` (
  ...
  `delete_time` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT '删除时间',
  `name` varchar(50) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '标签库分类',
...
CREATE TABLE IF NOT EXISTS `cmf_slide_item` (
  ...
  `status` tinyint(3) UNSIGNED NOT NULL DEFAULT '1' COMMENT '状态,1:显示;0:隐藏',
  `order_num` float NOT NULL DEFAULT '10000' COMMENT '排序',
  `title` varchar(50) NOT NULL DEFAULT '' COMMENT '标签库名称',
  `image` varchar(255) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '标签库图片',
  `url` varchar(255) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '标签库链接',
  `target` varchar(10) NOT NULL DEFAULT '' COMMENT '友情链接打开方式',
  `description` varchar(255) CHARACTER SET utf8 NOT NULL COMMENT '标签库描述',
  `content` text CHARACTER SET utf8 COMMENT '标签库内容',
  `more` text COMMENT '扩展信息',
  PRIMARY KEY (`id`),
  KEY `slide_id` (`slide_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='标签库子项表';
